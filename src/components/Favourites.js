...
const Favourites = () => {
    ...
    useEffect(()=> {
        axios.get('https://surreal-estate-iota.vercel.app/api/v1/Favourite?populate=propertyListing')
        .then(
        (res) => 
    ...
    const removeFavourite = (_id) => {
        axios.delete(`https://surreal-estate-iota.vercel.app/api/v1/Favourite/${_id}`)
